    ...
    <div className="about-page" style={{ backgroundColor: 'rgba(255, 255, 255, 0.97)', minHeight: '100vh' }}>
      <div className="about-container">
        <div className="about-card">
          <img src="/imagen/jhon.png" alt="Jhon Adames portrait" className="profile-image" />
          <h1>Jhon Adames</h1>
          <p>
          ...
          <a href="/document/Jhon-Adames-Resume.pdf" target="_blank" rel="noopener noreferrer" className="resume-link">
            📄 View My Resume
          </a>
        </div>
      </div>
